 ...
 *
 * Public functions to retrieve new cursors from the BTTNCUR DLL
 * based on ordinal to prevent applications from necessarily calling
 * LoadCursor directly on the DLL.
 *
